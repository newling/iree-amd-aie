// RUN: iree-opt --pass-pipeline='builtin.module(func.func(iree-amdaie-bufferize-to-allocation{memory-space=1 bufferize-operand=pack pack-depth=2}))' --split-input-file --verify-diagnostics %s | FileCheck %s
